...
| or | 둘 중 하나라도 1이면 1 반환 | `or rax, rbx` -> `00000001 | 00000010 = 00000011` |
...
> **핵심 요약:** 산술 연산과 비트 연산은 레지스터 및 메모리 내 데이터를 효율적으로 조작하는 데 필수적인 기술이다.

---

📂 본 문서는 `pwn-from-zero` 프로젝트의 Arithmetic Instructions 파트입니다.
