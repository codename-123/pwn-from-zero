## 📚 Libc Functions: scanf를 이용한 사용자 입력 처리
...
📂 본 문서는 `pwn-from-zero` 프로젝트의 **Libc Functions** 파트입니다.

> 📌 참고 출처: Hack The Box Academy ([https://academy.hackthebox.com](https://academy.hackthebox.com))
